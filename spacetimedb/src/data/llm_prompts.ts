...
const CREATION_ABILITY_SCHEMA = `{
      ...
      "resourceCost": "number (mana abilities: 10-30, stamina abilities: 5-15, 0 for 'none' resource type)",
...
${archetype === 'warrior' ? 'The WARRIOR archetype covers the full spectrum of physical and martial classes — fighters, barbarians, rogues, thieves, assassins, rangers, bards, monks, paladins, berserkers, swashbucklers, and anything else that fights with body, blade, or cunning rather than pure magic. The race + archetype combination should inspire something unique. A crystalline race warrior might be a Shardbreaker; a shadow race warrior might be a Veilblade. Lean toward physical stats (STR/DEX primary), higher HP, and melee/ranged physical abilities. Mana costs should be low or zero. Pick heavier armor (chain/plate for tanks, leather for agile types) and physical weapons (sword, axe, mace, dagger, bow, rapier, greatsword).' : 'The MYSTIC archetype covers the full spectrum of magical and spiritual classes — wizards, sorcerers, necromancers, druids, clerics, shamans, warlocks, enchanters, summoners, healers, elementalists, and anything else that channels arcane, divine, or natural power. The race + archetype combination should inspire something unique. A volcanic race mystic might be a Pyroclast; a deep-sea race mystic might be a Tidecaller. Lean toward magical stats (INT/WIS primary), higher mana, and spell-oriented abilities. Embrace magical damage types (arcane, fire, ice, shadow, holy, nature). Pick lighter armor (cloth/leather) and magical weapons (staff, wand, dagger).'}

Pick weapon and armor proficiencies that match the class fantasy. Physical classes favor melee/ranged weapons and heavier armor; magical classes favor staves/wands and lighter armor. Hybrid or unconventional classes can mix.
...
${archetype === 'warrior' ? 'The WARRIOR archetype covers the full spectrum of physical and martial classes — fighters, barbarians, rogues, thieves, assassins, rangers, bards, monks, paladins, berserkers, swashbucklers, and anything else that fights with body, blade, or cunning rather than pure magic. The race + archetype combination should inspire something unique. Lean toward physical stats (STR/DEX primary), higher HP, and melee/ranged physical abilities. Mana costs should be low or zero. Pick heavier armor (chain/plate for tanks, leather for agile types) and physical weapons (sword, axe, mace, dagger, bow, rapier, greatsword).' : 'The MYSTIC archetype covers the full spectrum of magical and spiritual classes — wizards, sorcerers, necromancers, druids, clerics, shamans, warlocks, enchanters, summoners, healers, elementalists, and anything else that channels arcane, divine, or natural power. The race + archetype combination should inspire something unique. Lean toward magical stats (INT/WIS primary), higher mana, and spell-oriented abilities. Embrace magical damage types (arcane, fire, ice, shadow, holy, nature). Pick lighter armor (cloth/leather) and magical weapons (staff, wand, dagger).'}
...
Generate a region linked to this character: 3-5 locations, 1-2 NPCs, 2-3 enemy types. IMPORTANT: Each location MUST have its own unique description that captures what makes THAT specific place distinct — do NOT reuse or copy the region description for individual locations. IMPORTANT: The first safe location (isSafe: true) MUST have at least one NPC with npcType 'vendor' and one with npcType 'banker'. These are essential services for new players. Respond with ONLY valid JSON:
          ...
          skills: {
            ...
            items: {
              ...
              properties: {
                ...
                resourceCost: { type: 'number', description: 'Resource cost (mana: 10-30, stamina: 5-15, 0 for none)' },
  ...
  "perks": [
    {
      ...
      "resourceCost": "number — resource cost (mana: 10-30, stamina: 5-15, 0 for passive/none)",
