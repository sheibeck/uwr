export const RACE_DATA: Array<{
  ...
  },
  {
    ...
    bonus2Type: 'crit_chance', bonus2Value: 5n,
    levelBonusType: 'crit_chance', levelBonusValue: 5n,
    unlocked: true,
  },
  // New unlocked races (7)
  {
    ...
    bonus2Type: 'perception', bonus2Value: 50n,
    penaltyType: 'stat_dex', penaltyValue: 1n,
    levelBonusType: 'mana_regen', levelBonusValue: 1n,
    unlocked: true,
  },
  {
    name: 'Troll',
  ...
  },
  {
    ...
    availableClasses: '',
    bonus1Type: 'stat_dex', bonus1Value: 1n,
    bonus2Type: 'dodge', bonus2Value: 4n,
  ...
  },
  {
    ...
    levelBonusType: 'hit_chance', levelBonusValue: 5n,
    unlocked: true,
  },
  {
    name: 'Orc',
  ...
  // New locked races (4)
  {
    ...
    availableClasses: '',
    bonus1Type: 'spell_damage', bonus1Value: 4n,
    bonus2Type: 'dodge', bonus2Value: 3n,
    penaltyType: 'stat_str', penaltyValue: 1n,
  ...
  },
  {
    ...
    bonus2Type: 'hit_chance', bonus2Value: 3n,
    penaltyType: 'stat_dex', penaltyValue: 2n,
    levelBonusType: 'phys_damage', levelBonusValue: 1n,
    unlocked: false,
  },
  {
    ...
    levelBonusType: 'magic_resist', levelBonusValue: 5n,
    unlocked: false,
  },
];
