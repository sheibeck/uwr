...
export const WORLD_DROP_GEAR_DEFS: WorldDropItemDef[] = [
  ...
  // Formula: rawWeaponDamage = 5 + level + baseDamage + (dps / 2); Effective DPS = raw / speed_s
  { name: 'Iron Shortsword', slot: 'mainHand', armorType: 'none', rarity: 'common', tier: 1n, vendorValue: 5n, requiredLevel: 1n, allowedClasses: 'warrior,paladin,bard,spellblade,reaver,rogue,ranger', weaponType: 'sword', weaponBaseDamage: 4n, weaponDps: 5n, description: 'A serviceable iron blade. Reliable in close quarters.' },  // raw: 5+1+4+2=12, DPS: 3.43
  { name: 'Hunting Bow', slot: 'mainHand', armorType: 'none', rarity: 'common', tier: 1n, vendorValue: 5n, requiredLevel: 1n, allowedClasses: 'ranger', weaponType: 'bow', weaponBaseDamage: 8n, weaponDps: 10n, description: 'A sturdy bow designed for woodland game. Pulls smoothly.' },  // raw: 5+1+8+5=19, DPS: 3.8 (2H)
  { name: 'Gnarled Staff', slot: 'mainHand', armorType: 'none', rarity: 'common', tier: 1n, vendorValue: 5n, requiredLevel: 1n, allowedClasses: 'enchanter,necromancer,summoner,druid,shaman,monk,wizard,ranger', weaponType: 'staff', weaponBaseDamage: 8n, weaponDps: 10n, description: 'A twisted wooden staff thrumming with latent energy.' },  // raw: 5+1+8+5=19, DPS: 3.8 (2H)
  { name: 'Worn Mace', slot: 'mainHand', armorType: 'none', rarity: 'common', tier: 1n, vendorValue: 5n, requiredLevel: 1n, allowedClasses: 'paladin,cleric,druid,shaman,rogue,ranger', weaponType: 'mace', weaponBaseDamage: 4n, weaponDps: 5n, description: 'A heavy flanged mace showing signs of hard use.' },  // raw: 5+1+4+2=12, DPS: 3.43
  { name: 'Rusty Axe', slot: 'mainHand', armorType: 'none', rarity: 'common', tier: 1n, vendorValue: 5n, requiredLevel: 1n, allowedClasses: 'beastmaster,warrior,reaver,ranger', weaponType: 'axe', weaponBaseDamage: 5n, weaponDps: 7n, description: 'A broad axe dulled by rust but still fearsome.' },  // raw: 5+1+5+3=14, DPS: 3.5
  { name: 'Notched Rapier', slot: 'mainHand', armorType: 'none', rarity: 'common', tier: 1n, vendorValue: 5n, requiredLevel: 1n, allowedClasses: 'bard,ranger', weaponType: 'rapier', weaponBaseDamage: 3n, weaponDps: 4n, description: 'A slender rapier with a chipped edge. Fast and precise.' },  // raw: 5+1+3+2=11, DPS: 3.67
  { name: 'Chipped Dagger', slot: 'mainHand', armorType: 'none', rarity: 'common', tier: 1n, vendorValue: 4n, requiredLevel: 1n, allowedClasses: 'rogue,enchanter,necromancer,summoner,wizard,shaman,druid,monk,ranger', weaponType: 'dagger', weaponBaseDamage: 3n, weaponDps: 4n, description: 'A small blade with a nicked edge. Quick draw, quick strike.' },  // raw: 5+1+3+2=11, DPS: 3.67
  { name: 'Cracked Blade', slot: 'mainHand', armorType: 'none', rarity: 'common', tier: 1n, vendorValue: 4n, requiredLevel: 1n, allowedClasses: 'spellblade,reaver,ranger', weaponType: 'blade', weaponBaseDamage: 4n, weaponDps: 5n, description: 'A fractured sword that channels both steel and sorcery.' },  // raw: 5+1+4+2=12, DPS: 3.43
  { name: 'Crude Greatsword', slot: 'mainHand', armorType: 'none', rarity: 'common', tier: 1n, vendorValue: 5n, requiredLevel: 1n, allowedClasses: 'warrior,paladin,reaver,spellblade,ranger', weaponType: 'greatsword', weaponBaseDamage: 9n, weaponDps: 11n, description: 'A massive blade meant for two-handed sweeping strikes. Crude but powerful.' },  // raw: 5+1+9+5=20, DPS: 4.0 (2H)

  // Tier 2 weapons (requiredLevel: 11n) — damage scaled inversely with weapon speed
  { name: 'Steel Longsword', slot: 'mainHand', armorType: 'none', rarity: 'common', tier: 2n, vendorValue: 12n, requiredLevel: 11n, allowedClasses: 'warrior,paladin,bard,spellblade,reaver,rogue,ranger', weaponType: 'sword', weaponBaseDamage: 6n, weaponDps: 7n, description: 'Forged steel with a keen edge. A significant upgrade over iron.' },  // raw: 5+11+6+3=25, DPS: 7.14
  { name: 'Yew Bow', slot: 'mainHand', armorType: 'none', rarity: 'common', tier: 2n, vendorValue: 12n, requiredLevel: 11n, allowedClasses: 'ranger', weaponType: 'bow', weaponBaseDamage: 11n, weaponDps: 13n, description: 'A flexible yew bow with superior range and draw weight.' },  // raw: 5+11+11+6=33, DPS: 6.6 (2H)
  { name: 'Oak Staff', slot: 'mainHand', armorType: 'none', rarity: 'common', tier: 2n, vendorValue: 12n, requiredLevel: 11n, allowedClasses: 'enchanter,necromancer,summoner,druid,shaman,monk,wizard,ranger', weaponType: 'staff', weaponBaseDamage: 11n, weaponDps: 13n, description: 'A dense oak staff carved with faint runes.' },  // raw: 5+11+11+6=33, DPS: 6.6 (2H)
  { name: 'Steel Greatsword', slot: 'mainHand', armorType: 'none', rarity: 'common', tier: 2n, vendorValue: 12n, requiredLevel: 11n, allowedClasses: 'warrior,paladin,reaver,spellblade,ranger', weaponType: 'greatsword', weaponBaseDamage: 12n, weaponDps: 14n, description: 'A well-forged two-handed blade. Its weight cleaves through armor.' },  // raw: 5+11+12+7=35, DPS: 7.0 (2H)
  ...
  { name: 'Flanged Mace', slot: 'mainHand', armorType: 'none', rarity: 'common', tier: 2n, vendorValue: 12n, requiredLevel: 11n, allowedClasses: 'paladin,cleric,druid,shaman,rogue,ranger', weaponType: 'mace', weaponBaseDamage: 6n, weaponDps: 7n, description: 'A reinforced mace with protruding flanges for armor-piercing strikes.' },  // raw: 5+11+6+3=25, DPS: 7.14
  { name: 'Hardened Axe', slot: 'mainHand', armorType: 'none', rarity: 'common', tier: 2n, vendorValue: 12n, requiredLevel: 11n, allowedClasses: 'beastmaster,warrior,reaver,ranger', weaponType: 'axe', weaponBaseDamage: 8n, weaponDps: 10n, description: 'A tempered axe head on an ironwood haft. Cleaves deep.' },  // raw: 5+11+8+5=29, DPS: 7.25
  { name: 'Stiletto', slot: 'mainHand', armorType: 'none', rarity: 'common', tier: 2n, vendorValue: 12n, requiredLevel: 11n, allowedClasses: 'rogue,enchanter,necromancer,summoner,wizard,shaman,druid,monk,ranger', weaponType: 'dagger', weaponBaseDamage: 4n, weaponDps: 6n, description: 'A needle-thin blade designed for finding gaps in armor.' },  // raw: 5+11+4+3=23, DPS: 7.67
  { name: 'Dueling Rapier', slot: 'mainHand', armorType: 'none', rarity: 'common', tier: 2n, vendorValue: 12n, requiredLevel: 11n, allowedClasses: 'bard,ranger', weaponType: 'rapier', weaponBaseDamage: 4n, weaponDps: 6n, description: 'An elegant thrusting sword favored by duelists.' },  // raw: 5+11+4+3=23, DPS: 7.67
  { name: 'Tempered Blade', slot: 'mainHand', armorType: 'none', rarity: 'common', tier: 2n, vendorValue: 12n, requiredLevel: 11n, allowedClasses: 'spellblade,reaver,ranger', weaponType: 'blade', weaponBaseDamage: 6n, weaponDps: 7n, description: 'A balanced blade forged for hybrid combat styles.' },  // raw: 5+11+6+3=25, DPS: 7.14
];
