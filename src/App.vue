...
const onShowAbilityPopupFromPanel = (payload: { name: string; description: string; x: number; y: number }) => {
  showAbilityPopup({ ...payload, stats: [] });
};
