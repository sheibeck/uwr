...
Last activity: 2026-02-18 - Completed quick task 173: added modifier reagent acquisition paths (MODIFIER_REAGENT_THRESHOLDS constant, creature-type-affinity loot table seeding for mid/high-tier terrains, 15% runtime combat drops per kill with level gating, 30% bonus modifier reagent on salvage); all 9 crafting dialog modifier reagents now obtainable through gameplay; module republished without --clear-database
