...
Last activity: 2026-02-18 - Completed quick task 178: consolidated enemy ability definitions into ENEMY_ABILITIES + ENEMY_TEMPLATE_ABILITIES constants; ensureEnemyAbilities() now reads from constants via loop, eliminating 40 hardcoded upsert calls; adding a new enemy ability requires editing only enemy_abilities.ts
