...
Last activity: 2026-02-18 - Completed quick task 168: added recipe hover tooltips to CraftingPanel — outputItem field added to useCrafting recipe entries, mouseenter/mousemove/mouseleave handlers emit show/move/hide-tooltip from CraftingPanel recipe cards, App.vue wires CraftingPanel to existing showTooltip/moveTooltip/hideTooltip handlers (same pipeline as LootPanel and VendorPanel)
