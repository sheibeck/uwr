...
Last activity: 2026-02-18 - Completed quick-207: removed delete-all-EnemySpawnMember loop from player-death spawn restore block; un-pulled members preserved; remainingMemberCount counts existing rows before re-inserting pulled survivors; groupCount = un-pulled + pulled survivors with hp > 0. Previous: quick-206 (leash-restore EnemySpawnMember re-insertion).
