...
Last activity: 2026-02-18 - Completed quick task 166: centralized all crafting metadata (CONSUMABLE_RECIPES, GEAR_RECIPES, GEAR_RECIPE_NAMES, ESSENCE_TIER_THRESHOLDS, vendorValue+gatherEntries on MaterialDef) in crafting_materials.ts; refactored ensure_items/location/combat to consume from single source of truth; module republished with no behavioral changes
