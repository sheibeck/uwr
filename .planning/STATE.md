...
Last activity: 2026-02-18 - Completed quick-206: added second loop in leash-restore block of combat.ts to re-insert EnemySpawnMember rows for actively-pulled CombatEnemy rows, restoring groupCount to full original spawn composition after all-flee events. Previous: quick-205 (auto-resolve time-based world events on timer expiry).
