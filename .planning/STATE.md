...
Last activity: 2026-02-19 - Completed quick-205: wired EventDespawnTick scheduled table into fireWorldEvent so time-based world events automatically resolve to 'failed' at deadline; despawn_event_content reducer updated to call resolveWorldEvent instead of despawnEventContent. Previous: quick-204 (world event kill credit fix).
