...
Last activity: 2026-02-18 - Completed quick task 180: fixed critical bug in rollQualityTier where getMaxTierForLevel() hard-capped all T1 enemies to 0% affixed drops; replaced with level-scaled uncommon chance ramp (~5% at L1 → ~15-35% at L8-10 with danger bonus)
