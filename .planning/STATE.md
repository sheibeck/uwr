...
Last activity: 2026-02-17 - Completed quick task 133: Removed redundant rarity text labels from vendor panel item lists and inventory context menu subtitle — quality is now communicated by name color only.
