...
Last activity: 2026-02-18 - Completed quick-204: replaced EventSpawnEnemy->EnemySpawn kill credit chain with WORLD_EVENT_DEFINITIONS definition-based lookup; fixes Hollowmere Infestation Bog Rat kill credit. Previous: quick-203 (CI workflow cleanup, /setappversion command).
