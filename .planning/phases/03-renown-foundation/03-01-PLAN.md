...
Scope note: REQ-023 defines three standing sources (kills, quest completion, tribute). This phase implements kill-based standing only. Quest-completion and tribute-based standing are explicitly deferred to a future phase sub-task once the quest and economy systems support them.
