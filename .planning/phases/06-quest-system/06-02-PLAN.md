...
must_haves:
  truths:
    ...
    - "Players can accept all 4 new quest types from affinity-gated NPC dialogue"
    - "Delivery chain Marla -> Thessa -> Mordane accessible through progressive affinity and quest completion"
    - "Each quest type has at least 2 seeded quests spanning multiple NPCs and regions"
  artifacts:
