...
must_haves:
  truths:
    ...
    - "Crafting a gear recipe with a Tier 1 material produces an item with craftQuality='standard' and qualityTier='common'"
    - "Crafting any gear recipe requires Essence I as a third ingredient (req3) in addition to the two primary materials"
    - "All crafting materials (including Copper Ore and Essence I/II/III) are listed and seeded together in a single ensureGearMaterialItemTemplates function"
  artifacts:
