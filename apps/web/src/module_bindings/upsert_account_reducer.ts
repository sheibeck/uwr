...
let _cached_UpsertAccount_type_value: __AlgebraicTypeType | null = null;
...
export const UpsertAccount = {
  ...
  */
  getTypeScriptAlgebraicType(): __AlgebraicTypeType {
    ...
    _cached_UpsertAccount_type_value = __AlgebraicTypeValue.Product({ elements: [] });
  ...
  serialize(writer: __BinaryWriter, value: UpsertAccount): void {
    __AlgebraicTypeValue.serializeValue(writer, UpsertAccount.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): UpsertAccount {
    return __AlgebraicTypeValue.deserializeValue(reader, UpsertAccount.getTypeScriptAlgebraicType());
  },
